    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{
          ...
          {(convo.unread_count ?? 0) > 0 && <div style={{ width: "8px", height: "8px", borderRadius: "50%", backgroundColor: "#ef4444", flexShrink: 0 }} />}
        </div>
      </div>
    </div>
  );
                      ...
                      <div style={{ position: "relative" }}>
                        ...
                        {isGifPickerOpen && createPortal(
                          ...
                          >
                            ...
                            >
                              <GifPicker 
                                onSelect={(gifUrl) => { handleSendMessage(undefined, gifUrl); setIsGifPickerOpen(false); }} 
