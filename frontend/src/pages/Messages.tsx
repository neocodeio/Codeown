...
export default function Messages() {
    ...
    return (
        <main className="container" style={{ padding: "40px 20px", height: "calc(100vh - 80px)", display: "flex", gap: "20px" }}>
            {/* Sidebar */}
            <div style={{
                width: "350px",
                    ...
                    <>
                        ...
                        <div style={{
                            ...
                            <div>
                                ...
                                <div style={{ fontSize: "12px", color: "#666" }}>@{activeConvo.partner.username}</div>
                            </div>
                        </div>

                        {/* Messages */}
                        <div style={{ flex: 1, overflowY: "auto", padding: "25px", display: "flex", flexDirection: "column", gap: "10px" }}>
                        ...
                        <form
                            ...
                            style={{ padding: "20px 25px", borderTop: "1px solid #eee", display: "flex", gap: "12px" }}
                        >
                            <input
                                type="text"
                                value={newMessage}
