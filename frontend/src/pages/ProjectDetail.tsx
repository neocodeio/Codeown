            ...
            <div style={{ display: "flex", borderBottom: "0.5px solid var(--border-hairline)", marginBottom: "40px" }}>
              <button 
                ...
                style={{ 
                  ...
                  background: "none", 
                  border: "none", 
                  borderBottom: activeTab === "details" ? "3px solid #000000" : "3px solid transparent", 
                  color: activeTab === "details" ? "#000000" : "var(--text-tertiary)", 
                  fontWeight: 800, 
                  fontSize: "14px", 
                  cursor: "pointer",
                  borderRadius: "0",
              ...
              <button 
                ...
                style={{ 
                  ...
                  background: "none", 
                  border: "none", 
                  borderBottom: activeTab === "changelog" ? "3px solid #000000" : "3px solid transparent", 
                  color: activeTab === "changelog" ? "#000000" : "var(--text-tertiary)", 
                  fontWeight: 800, 
                  fontSize: "14px", 
                  cursor: "pointer",
                  borderRadius: "0",
